...
{/* <SearchBar/> */}
        ...
        <div className="flex items-center justify-between ml-1 sm:ml-0 gap-0.5 sm:gap-7 relative">
          ...
          <span className="userDropDown flex items-center text-black font-medium gap-1 cursor-pointer" onClick={() =>openSearch()}>
            <SearchIcon />
          </span>


          {isAuthenticated === false ?
            <Link to="/login" className="px-3 sm:px-9 py-0.5 text-primary-blue bg-black border font-medium rounded-sm cursor-pointer">Login</Link>
            :
            (
          ...
          <Link to="/wishlist" className="flex items-center text-gray font-medium gap-2 relative">
          ...
          <Link to="/cart" className="flex items-center text-gray font-medium gap-2 relative">
