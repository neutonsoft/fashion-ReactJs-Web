export const MENUITEMS = [
  ...
  { path: "/about-us", title: "About_Us", type: "link", children: [] },
  { path: "/contact", title: "Contact", type: "link", children: [] },
];
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "/products", title: "Right Sidebar", type: "link" },
          { path: "/products", title: "No Sidebar", type: "link" },
        ],
      },
      {
