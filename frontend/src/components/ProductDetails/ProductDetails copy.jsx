...
//                         Instant discount on first Tito Pay Later order of
//                         500 and above{" "}
...
//                     <p className="text-gray-500 mb-0">Delivery</p>
...
//                     <p className="text-gray-500 font-medium  mb-0">Services</p>
...
//                   {/* <!-- seller details --> */}
//                   <div className="flex gap-16 mt-4 items-center text-sm font-medium">
//                     <p className="text-gray-500  mb-0">Seller</p>
...
//                         key={i}
//                       >
//                         <p className="text-gray-500 w-3/12  mb-0">
//                           {spec.title}
//                         </p>
//                         <p className="flex-1  mb-0">{spec.description}</p>
//                       </div>
//                     ))}
//                     {/* <!-- specs list --> */}
//                   </div>
