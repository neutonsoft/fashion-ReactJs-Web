...
const Product = ({ _id, name, images, ratings, numOfReviews, price, cuttedPrice }) => {
    ...
    return (
        <div className="flex flex-col items-start gap-2 px-4 py-6 relative hover:shadow-lg rounded-sm">
            ...
            {/* <!-- product description --> */}
            <span onClick={addToWishlistHandler} className={`${itemInWishlist ? "text-red-500" : "hover:text-red-500 text-gray-300"} absolute top-12 right-6 cursor-pointer`}><ShoppingCartIcon sx={{ fontSize: "18px" }} /></span>
