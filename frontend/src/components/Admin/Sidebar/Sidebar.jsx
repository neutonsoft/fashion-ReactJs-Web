...
const Sidebar = ({ activeTab, setToggleSidebar }) => {
  ...
  return (
    <aside className="sidebar z-10 sm:z-0 block min-h-screen  left-0 pb-14 max-h-screen w-3/4 sm:w-64 bg-gray-800 text-white  border-r">
      <div className="flex items-center gap-3 bg-gray-700 py-2 px-1 rounded-lg shadow-lg my-4 mx-2">
