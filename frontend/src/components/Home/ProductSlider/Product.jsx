...
const Product = (props) => {
    ...
    return (
        <div className="flex flex-col items-center shadow-md bg-primary-white, 
         rounded-sm overflow-hidden my-10 mr-10 px-2 py-6 relative h-96 " >
            ...
            {/* <!-- wishlist badge --> */}
            <span onClick={addToWishlistHandler} className={`${itemInWishlist ? "text-red-500" : "hover:text-red-500 text-gray-300"} absolute top-12 right-2 cursor-pointer`}><ShoppingCartIcon sx={{ fontSize: "18px" }} /></span>
